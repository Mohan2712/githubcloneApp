...
class _LoginPageState extends State<LoginPage> {
  ...
  void onClickGitHubLoginButton() async {
    const String url =
        "https://github.com/login/oauth/authorize?client_id=${SecretKey.GITHUB_CLIENT_ID}&scope=public_repo%20read:user%20user:email";
                      ...
                      child: ElevatedButton(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              //Image.asset('assets/GitHub-Mark-Light.png'),
                              SizedBox(
                                width: width * 0.02,
                              ),
                              Text(
